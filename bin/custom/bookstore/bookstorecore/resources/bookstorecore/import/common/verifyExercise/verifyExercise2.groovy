...
bookTypeMap.put("publisher","java.lang.String");
bookTypeMap.put("publishedDate","java.util.Date");
bookTypeMap.put("edition","java.lang.Integer");
...
checkOptionalAttributes( "Book", "edition", "authors" );
...
def propertiesMap=[
    ...
    'type.Book.language.name',
	'type.Book.language.description',
	'type.Book.ISBN10.name',
	'type.Book.ISBN10.description',
	'type.Book.ISBN13.name',
	'type.Book.ISBN13.description',
	'type.Book.publisher.name',
	'type.Book.publisher.description',
	'type.Book.publishedDate.name',
	'type.Book.publishedDate.description',
